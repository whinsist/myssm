...
public class Test13SnowFlake {
    ...
    public Test13SnowFlake(long datacenterId, long machineId) {
    ...
    public static void main(String[] args) {
        Test13SnowFlake snowFlake = new Test13SnowFlake(2, 3);

        long start = System.currentTimeMillis();
        for (int i = 0; i < 30; i++) {
            System.out.println("第一种：" + snowFlake.nextId());
        }
        ...
        for (int i = 0; i < 30; i++) {
            System.out.println("第二种：" + worker.nextId());
        }

        SnowflakesTools idWorker = new SnowflakesTools(0, 0);
        for (int i = 0; i < 1000; i++) {
            long id = idWorker.nextId();
            System.out.println("第三种：" + idWorker.nextId());
        }
