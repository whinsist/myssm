...
<c:set var="menuKey" value="orderAuditProcessed"/>
<html lang="en">
	<head>
		<title>后台管理-自服务(普通用户)</title>
		<meta charset="utf-8" />
	...
	<body class="no-skin">
					...
					<form class="form-horizontal" method="post" action="" role="form" id="addForm" novalidate="novalidate">
						<div class="col-xs-12">
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" ><span style="color: red;">*</span>用户名</label>
								<div class="col-sm-6">
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/resources/admin/order_audit/js/order_audit_list_processed.js"></script>
		<script type="text/javascript">
            setCurrentUserInfo();
			$(function(){
				//提示信息
