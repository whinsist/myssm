...
<html lang="en">
	...
	<body class="no-skin">
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/resources/admin/order_audit/js/order_audit_list_pending.js"></script>
		<script type="text/javascript">
            setCurrentUserInfo();
			$(function(){
				//提示信息
