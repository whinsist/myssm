										...
										<div class="col-xs-12 col-sm-3 center">
											<div>
												...
												<span class="profile-picture">
													<img id="avatar" class="editable img-responsive" alt="Alex's Avatar" src="/attach/down.do?relativeUrl=${userEntity.headImage}" width="180px" height="200"/>
...
&nbsp;
		...
		<!-- ace scripts -->
		<script src="${pageContext.request.contextPath}/resources/assets/js/ace-elements.js"></script>
		<script src="${pageContext.request.contextPath}/resources/assets/js/ace.js"></script>
		
		<script type="text/javascript">
		// 获取当前用户
        setCurrentUserInfo();
        // var userInfo = getSyncCurrentUser();
        // $('#avatar').attr("src", "/attach/down.do?relativeUrl="+userInfo.headImage);
    	// $('#currentUserHeadImage').attr("src", "/attach/down.do?relativeUrl="+userInfo.headImage);
			...
			try {//ie8 throws some harmless exceptions, so let's catch'em
				...
				$('#avatar').editable({
					...
					url: function(params) {
						...
						// my new add
						var submit_url = "${pageContext.request.contextPath}" + '/v1/attach/upload';
						var deferred = null;
						var avatar = '#avatar';
						...
						if( "FormData" in window ) {
							...
							$form.find('input[type=file]').each(function(){
								...
								if(files && files.length > 0) {
									...
									formData_object.append("file", files[0]);
								}
							});
						...
						.done(function(result) {//success
							...
							// my new add
							if (result.code == 200) {
								var relativeUrl = result.data[0].relativeUrl;
								var showImageUrl = result.data[0].systemViewUrl;
								
								
								var content = {"userSid":$("#currentUserId").val(), "headImage":relativeUrl};
								// 更新用户头像 
								$.ajax({
							        type: "POST",
							        url: "${pageContext.request.contextPath}" + '/v1/back/users/edit_profile',
							        ...
							        success: function(res){
							        	if (res.code == 200) {
							        		...
							        		$('#avatar').attr("src", showImageUrl);
								        	$('#currentUserHeadImage').attr("src", showImageUrl);
							        	} else{
                                ...
                                $.message("warn", "上传失败："+result.message+"; result="+result);
							}
						})
