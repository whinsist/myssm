...
<c:set var="menuKey" value="processList"/>
<html lang="en">
	<head>
		<title>后台管理-流程列表</title>
		<meta charset="utf-8" />
	...
	<body class="no-skin">
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/resources/admin/process/js/process_list.js"></script>
		<script type="text/javascript">
            setCurrentUserInfo();
			$(function(){
				//提示信息
