...
<c:set var="menuKey" value="decItemList"/>
<html lang="en">
	<head>
	...
	<body class="no-skin">
					...
					<div class="page-content">
						<div class="row h6">
							<form id="searchFrom">
								<div class="row h6">
									<div class="col-sm-1">
										<label class="control-label list_label col-sm-12 no-padding-right">姓名：</label>
									</div>
									<div class="col-sm-1">
										<input class="form-control list_input" type="text" id="userName_search" name="userName"  placeholder="请输入姓名">
									</div> 
									<div class="col-sm-1">
										<label class="control-label list_label col-sm-12 no-padding-right">电话：</label>
									</div>
									<div class="col-sm-1">
										<input class="form-control list_input" type="text" id="userPhone_search" name="userPhone"  placeholder="请输入电话">
									</div>  
								</div>
							</form>
							<div class="row">
					...
					<form class="form-horizontal" method="post" action="" role="form" id="addForm" novalidate="novalidate">
						<div class="col-xs-12">
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="userName"><span style="color: red;">*</span>商品名</label>
								<div class="col-sm-6">
									<input type="text" name="userName" id="form-userName" value="" maxlength="2000" placeholder="商品名" class="col-xs-10 col-sm-12">
								</div>
								<div class="col-sm-3">
						...
						<div class="col-xs-12">
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="userType">商品类型</label>
								<div class="col-sm-6">
									<input type="text" name="userType" id="form-userType" value="" maxlength="2000" placeholder="商品类型" class="col-xs-10 col-sm-12">
								</div>
								<div class="col-sm-3">
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/resources/admin/decItem/js/decItem_list.js"></script>
		<script type="text/javascript">
			$(function(){
				//提示信息
