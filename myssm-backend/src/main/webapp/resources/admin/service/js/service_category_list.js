...
jQuery(function($) {
	...
	*/ 
	jQuery(grid_selector).jqGrid({
		...
		url: ctx + "/v1/back/service_category",
		mtype: "POST",
		datatype: "json",
		...
		colModel:[
			...
			{label:'服务目录名称',name:'serviceName',index:'serviceName',editable:true},
			{label:'描述',name:'serviceDesc',index:'serviceDesc',editable:false,sortable:true},
			{label:'serviceForm',name:'serviceForm',index:'serviceForm',editable:false},
    ...
    function editLink(cellValue, options, rowdata, action) {
        var url = ctx + "/v1/back/page/service/service_category_detail?id=" + rowdata.id;
        return "<a href='"+url+"'>申请</a>";
    }
