...
jQuery(function($) {
	...
	*/ 
	jQuery(grid_selector).jqGrid({
		...
		editurl: ctx + "/v1/back/process/deleteOrUpdate",
		url: ctx + "/v1/back/service_order",
		mtype: "POST",
		datatype: "json",
		...
		colModel:[
			...
			{label:'订单号',name:'orderSn',index:'orderSn',editable:true},
			{label:'服务名称',name:'name',index:'name',editable:false,sortable:true},
			{label:'类型',name:'typeName',index:'typeName',editable:false},
			{label:'申请人',name:'applicant',index:'applicant',editable:false},
			{label:'状态',name:'statusName',index:'statusName',editable:false},
            {label:'',name:'',index:'', formatter: editLink},
    ...
    function editLink(cellValue, options, rowdata, action) {
        var url = ctx + "/v1/back/page/service/service_order_detail?id=" + rowdata.id;
