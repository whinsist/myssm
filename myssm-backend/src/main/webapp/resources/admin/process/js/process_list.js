	...
	*/ 
	jQuery(grid_selector).jqGrid({
		...
		colModel:[
			...
			{label:'流程名称',name:'processName',index:'processName',editable:true},
			{label:'流程类型',name:'businessCode',index:'businessCode',editable:false,sortable:true},
			{label:'流程定义Key',name:'processCode',index:'processCode',editable:false},
    ...
    function editLink(cellValue, options, rowdata, action) {
        var url = ctx + "/v1/back/page/process/process_detail?id=" + rowdata.id;
        return "<a href='"+url+"'>管理</a>";
    }
