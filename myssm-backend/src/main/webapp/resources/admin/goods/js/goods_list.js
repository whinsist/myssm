...
jQuery(function($) {
	...
	*/ 
	jQuery(grid_selector).jqGrid({
		caption: "商品列表",
		editurl: "/admin/goods/deleteOrUpdate.do",
		url: "/admin/goods/listJson.do",
		mtype: "POST",
		datatype: "json",
		...
		colModel:[
			...
			{label:'ID',name:'id',index:'id',editable:false,sortable:false,formatter:userNameFormat},
			{label:'商品名称',name:'goodsName',index:'goodsName',editable:true},
			{label:'商品图片',name:'pic',index:'pic',editable:false,formatter:picFormat},
			{label:'商品价格',name:'price',index:'price',editable:false,sortable:false},
			{label:'商品状态',name:'state',index:'state',editable:true,edittype:'select',editoptions:{value:"1:启用;0:禁用"},formatter:statusFormat},
			{label:'新增时间',name:'addTime_str',index:'addTime',editable:false,sortable:false},
    ...
    */
	...
	var function4Adding = function(e){
		window.location.href = ctx+"/admin/goods/add.do";
		return;
